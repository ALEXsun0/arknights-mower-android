> 以下为上游声明的保留副本；其中目录对应本项目 `android/`。未保留的上游模块不参与构建。
...
- **本项目中的位置**：[`app/src/main/java/com/aliothmoon/maameow/third/`](../../android/app/src/main/java/com/aliothmoon/maameow/third/)
