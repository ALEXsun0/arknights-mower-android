...
interface RemoteService {
    ...
    // Mower integration: scoped to the engine's game display.
    ParcelFileDescriptor mowerFrame() = 51;
    boolean mowerKey(int code) = 52;
    boolean mowerGame(String packageName, boolean launch) = 53;
    boolean mowerText(String text) = 54;
}
